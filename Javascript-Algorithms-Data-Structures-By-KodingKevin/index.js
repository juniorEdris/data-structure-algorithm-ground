...
// const text = 'aaaaaaaaaaaaaaaAbbbbbbbbbbeeeey'
...
//   const res = stringA.split("").sort().join("") ===                 stringB.split("").sort().join("");
//   return res;
//   // solution 2 ends
...
//   for (let i = 0; i < arr.length; i++) {
//     for (let j = 0; j < arr.length - i; j++) { // -i to make fewer iterations
//       if (arr[j] > arr[j + 1]) {
//         swap(arr, j, j + 1)
//       }
//     }
